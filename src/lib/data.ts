...
const wixImage = (name: string) => `${WIX_BASE}/${name}`;
...
export const STUDENT_ACTIVITIES: Activity[] = [
  {
    ...
    image: wixImage("264108_a593345fe69d4d81b000be71282d9b96~mv2.jpg"),
    gallery: [
  ...
  },
  {
    ...
    image: wixImage("264108_d23c2125531f41bcb313fd25de3b0768~mv2.jpeg"),
    gallery: [
  ...
  },
  {
    ...
    image: wixImage("264108_41d7137f1aea4ca09d9332793b616484~mv2.jpg"),
    gallery: [
  ...
  },
  {
    ...
    image: wixImage("264108_74cf5ecc56454e4493e8594d6deb6b22~mv2.jpeg"),
    gallery: [
  ...
  },
  {
    ...
    image: wixImage("264108_b253b85301ee4989be499aa5922a4cca~mv2.jpg"),
    gallery: [
  ...
  },
  {
    ...
    image: wixImage("264108_b5d0a5e4307744e6a00c19514381744b~mv2.jpg"),
    gallery: [
...
export const HERO_IMAGE = `${WIX_BASE}/264108_52efed543d584b71b3d59ef17424bcf1~mv2.jpg`;

export const ABOUT_IMAGE = `${WIX_BASE}/264108_09323084fc314b1ba11e42e4e3674528~mv2.jpg`;

export const STUDENT_LIFE_IMAGE = `${WIX_BASE}/264108_b253b85301ee4989be499aa5922a4cca~mv2.jpg`;

export const ACADEMICS_IMAGE = `${WIX_BASE}/264108_52efed543d584b71b3d59ef17424bcf1~mv2.jpg`;

export const SENIOR_HIGH_IMAGE = `${WIX_BASE}/264108_4f7061c183f7439d95a54c827893bb03~mv2.jpg`;

export const CAMPUS_IMAGE = `${WIX_BASE}/264108_09323084fc314b1ba11e42e4e3674528~mv2.jpg`;

export const GRADUATION_IMAGE = `${WIX_BASE}/264108_7e6412e165ca438098013b760eb28d7f~mv2.jpg`;

export const SCIENCE_LAB_IMAGE = `${WIX_BASE}/264108_52efed543d584b71b3d59ef17424bcf1~mv2.jpg`;

export const LIBRARY_IMAGE = `${WIX_BASE}/264108_4f7061c183f7439d95a54c827893bb03~mv2.jpg`;

export const COMPUTER_LAB_IMAGE = `${WIX_BASE}/264108_a791f3d2ab164737bdcc3da33dbfce9d~mv2.jpg`;

export const ADMISSIONS_IMAGE = `${WIX_BASE}/264108_a791f3d2ab164737bdcc3da33dbfce9d~mv2.jpg`;

export const CONTACT_IMAGE = `${WIX_BASE}/264108_fa65bcf7a56849c0aa6ed4c98b81aecb~mv2.jpg`;

export const TESTIMONIAL_IMAGE = `${WIX_BASE}/264108_40070ec9f3014a99878f682025e700c2~mv2.jpg`;

export const GRADUATES_IMAGE = `${WIX_BASE}/264108_7e6412e165ca438098013b760eb28d7f~mv2.jpg`;

export const GALLERY_IMAGES = [
  `${WIX_BASE}/264108_9feaaa3173074584ba15794b431346be~mv2.jpg`,
  `${WIX_BASE}/264108_52d94ce4aae047c298012c06cf1dc43d~mv2.jpg`,
  `${WIX_BASE}/264108_e8921fc4f57c44078fbf3a6a52e03dcc~mv2.jpg`,
  `${WIX_BASE}/264108_0e302c90cc604776a14085bd69b77eab~mv2.jpg`,
  `${WIX_BASE}/264108_186dae2a3a784ecab4b96b7c1f0b9b45~mv2.jpg`,
  `${WIX_BASE}/264108_6d080161323d43be95de5e085d3ec873~mv2.jpg`,
  `${WIX_BASE}/264108_b25d8aa76bf7420882fcd5ac087fa982~mv2.jpg`,
  `${WIX_BASE}/264108_4141276c1a774162addef58105bbb0ce~mv2.jpg`,
  `${WIX_BASE}/264108_0d0789839b15437e87634c7d3ac12991~mv2.jpg`,
  `${WIX_BASE}/264108_ed24f2a383c54079bd29740b703e0514~mv2.jpg`,
  `${WIX_BASE}/264108_db7109a00e974f4dbe5d7411b2d48774~mv2.jpg`,
  `${WIX_BASE}/264108_f2677beaef3f476c95ae656c58021130~mv2.jpg`,
  `${WIX_BASE}/264108_b5d0a5e4307744e6a00c19514381744b~mv2.jpg`,
  `${WIX_BASE}/264108_b7c53da797084517976e5a467d1a746c~mv2.jpg`,
  `${WIX_BASE}/264108_d9cc79c78d4a4fd08ff57db1d9e5e885~mv2.jpg`,
  `${WIX_BASE}/264108_7e6412e165ca438098013b760eb28d7f~mv2.jpg`,
];
